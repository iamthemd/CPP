...
#include <iostream>
/*
* Inline Function: Purpose of the inline function is to optimze the performance 
*                  interms of function call.
*	- when instruction executing function call usually control pass to the function body.
*     If we define function as inline function, then function call replaced by 
*     function body to avoid overhead of transfer control to the function body.
*     But it leads to increase the size of executable size.
*   - It is not necesarry that compiler always replace inline function with funtion body,
*     not like MACRO.
*	- A function defined entirely under class/struct/union definition, 
*     whether it's a member function or non-member friend function, 
